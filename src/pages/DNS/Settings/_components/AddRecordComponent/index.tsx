import React, { FC, memo, Ref, useState } from 'react';
...
import ViewPopover from './_component/ViewPopover';
import HostPopover from './_component/HostPopover';
import RdataPopover from './_component/RdataPopover';
import TTLPopover from '@/pages/DNS/Settings/_components/AddRecordComponent/_component/TTLPopover';
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              <Input
                placeholder={formatMessage({ id: 'dns.keywords.value' })}
              />
            </Form.Item>
            <Popover
              overlayClassName={styles.popoverContent}
